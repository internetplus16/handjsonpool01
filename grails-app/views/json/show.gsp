...
<body>
<a href="#show-json" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
...
<ol class="property-list json">
    ...
    <g:if test="${jsonInstance?.placeholderUrl}">
        <li class="fieldcontain">
            <span id="placeholderUrl-label" class="property-label"><g:message code="json.placeholderUrl.label"
                                                                              default="Placeholder Url"/></span>

            <span class="property-value" aria-labelledby="placeholderUrl-label"><g:fieldValue bean="${jsonInstance}"
                                                                                              field="placeholderUrl"/></span>
    ...
    <g:if test="${jsonInstance?.method}">
        <li class="fieldcontain">
            <span id="method-label" class="property-label"><g:message code="json.method.label"
                                                                      default="Method"/></span>

            <span class="property-value" aria-labelledby="method-label"><g:fieldValue bean="${jsonInstance}"
                                                                                      field="method"/></span>
    ...
    <g:if test="${jsonInstance?.jsonData}">
        <li class="fieldcontain">
            <span id="jsonData-label" class="property-label"><g:message code="json.jsonData.label"
                                                                        default="Json Data"/></span>

            <span class="property-value" aria-labelledby="jsonData-label"><g:fieldValue bean="${jsonInstance}"
                                                                                        field="jsonData"/></span>
    ...
    <g:if test="${jsonInstance?.dateCreated}">
        <li class="fieldcontain">
            <span id="dateCreated-label" class="property-label"><g:message code="json.dateCreated.label"
                                                                           default="Date Created"/></span>

            <span class="property-value" aria-labelledby="dateCreated-label"><g:formatDate
                    date="${jsonInstance?.dateCreated}"/></span>
    ...
    <g:if test="${jsonInstance?.lastUpdated}">
        <li class="fieldcontain">
            <span id="lastUpdated-label" class="property-label"><g:message code="json.lastUpdated.label"
                                                                           default="Last Updated"/></span>

            <span class="property-value" aria-labelledby="lastUpdated-label"><g:formatDate
                    date="${jsonInstance?.lastUpdated}"/></span>
    ...
    <g:if test="${jsonInstance?.project}">
        <li class="fieldcontain">
            <span id="project-label" class="property-label"><g:message code="json.project.label"
                                                                       default="Project"/></span>

            <span class="property-value" aria-labelledby="project-label"><g:link controller="project" action="show"
                                                                                 id="${jsonInstance?.project?.id}">${jsonInstance?.project?.encodeAsHTML()}</g:link></span>
...
<g:if test="${jsonInstance.project.user.loginName == session.user.loginName || session.user.loginName == "admin"}">
    <g:form url="[resource: jsonInstance, action: 'delete']" method="DELETE">
        <fieldset class="buttons">
            <g:link class="edit" action="edit" resource="${jsonInstance}"><g:message
...
>>>>>>> 7272a5dbee9c446828824888d2bc064f00234866
</html>
